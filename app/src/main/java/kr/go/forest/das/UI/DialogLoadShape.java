...
public class DialogLoadShape extends RelativeLayout implements View.OnClickListener, RadioGroup.OnCheckedChangeListener{
    ...
    public DialogLoadShape(Context context){
        super(context);
        this.context = context;
        initUI();
    }

    public DialogLoadShape(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initUI();
    }
